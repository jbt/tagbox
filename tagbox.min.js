...
allowNew:s,newText:"{{txt}}",emptyText:"Not Found",dropdownContainer:"body",maxItems:-1,autoShow:s},j);return this.each(function(){if(!e(this).data("tagbox")){var b=new y(this,c);e(this).data("tagbox",b)}})}})(jQuery,window);
