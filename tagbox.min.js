...
c.push(g)}c=c.sort(function(a,e){return e.i-a.i});for(r=0;r<c.length;r+=1)c[r]=c[r].item}else for(r=0;r<e.length;r+=1)!b.allowDuplicates&&l(e[r])||c.push(e[r]);m.q(c);m.p(f);m.l(w)}else m.hide()}function t(e){if(a.k!=k.val()||!0===e)a.c.toggleClass("full",a.a.length===b.maxItems),u(),a.k=k.val(),G.text(a.k),k.width(0),k.width(Math.min(a.c.width()-16,Math.max(a.c.width()-k.offset().left+a.c.offset().left+16,G.width(),1))),m.l(w)}var a=this;a.a=[];var e=!0;document.activeElement===d&&(e=!1);var c=a.input=
