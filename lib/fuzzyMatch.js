...
var fuzzyRank = (function(){
  ...
  var stripAccents = (function () {
    var accented   = 'àáâãäçèéêëìíîïñòóôõöùúûüýÿÀÁÂÃÄÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝ',
        unaccented = 'aaaaaceeeeiiiinooooouuuuyyAAAAACEEEEIIIINOOOOOUUUUY',
        matchRegex = new RegExp('[' + accented + ']', 'g'),
        translationTable = {}, i;
        lookup = function(chr){
    ...
    for(i = 0; i < accented.length; i += 1){
      translationTable[accented[i]] = unaccented[i];
    }
